...
Vous pouvez naviguer sur le site en vous rendant à l'adresse indiqué : "Running on http://ip_adress"
Probablement : http://127.0.0.1:5000/

Placer le script Python stress.py et recipe alpine.def et alpineBase.def dans votre dossier (ex: "flask_project")